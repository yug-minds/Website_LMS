...
export default async function SuccessStoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-white pt-12 md:pt-16 lg:pt-20 pb-0">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-1 md:mb-2 text-gray-900 max-w-6xl mx-auto">Success Stories</h1>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-700 max-w-full mx-auto leading-relaxed md:whitespace-nowrap mb-1">
      ...
      <section className="bg-blue-600 text-white py-8 md:py-12">
        <div className="container">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center mb-3 md:mb-4 max-w-5xl mx-auto">Impact by the Numbers</h2>
          <p className="text-blue-100 text-center mb-6 md:mb-8 max-w-2xl mx-auto text-base md:text-lg lg:text-xl">
