...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  ...
  const mousePositionRef = useMousePositionRef(containerRef || { current: null } as unknown as React.RefObject<HTMLElement>);
  ...
  useAnimationFrame(() => {
    ...
    letterRefs.current.forEach((letterRef, index) => {
      ...
      letterRef.style.transform = `scale(${1 + falloffValue * 0.1})`;
    });
  });
