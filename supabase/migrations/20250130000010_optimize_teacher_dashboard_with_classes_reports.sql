-- Optimize Teacher Dashboard Function - Include Classes and Reports
-- Created: 2025-12-07
-- Purpose: Include classes and reports in function to eliminate 3 additional queries (90-150ms overhead)

-- Replace the get_teacher_dashboard_stats_from_mv function to include classes and reports
-- This eliminates the need for separate queries after function call
...
COMMENT ON FUNCTION get_teacher_dashboard_stats_from_mv(UUID) IS 'Fully optimized function combining all subqueries and including classes/reports. Eliminates 3 additional queries (90-150ms overhead) by returning everything in one call.';
